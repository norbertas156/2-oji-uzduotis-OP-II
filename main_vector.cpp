...
void mediana(Studentas A[], int n){
	double temp=0;
	sort(A[n].pazymiai.begin(), A[n].pazymiai.end());
...
void Ivedimas(Studentas A[], int & i){
	...
	if(ndskz=='t'){
		cout<<"Iveskite pazymiu skaiciu"<<endl;
			...
			if(ndskr=='t'){
				...
				for(int j=0; j<A[i].pazymiusk; j++){
					A[i].pazymiai.insert(A[i].pazymiai.begin(),Sktikrinimas());
				}
				...
				for(int j=0; j<A[i].pazymiusk; j++){
					...
					A[i].pazymiai.insert(A[i].pazymiai.begin(),a);
					cout<<A[i].pazymiai[0]<<" ";
					}
		...
		A[i].pazymiai.insert(A[i].pazymiai.begin(),Sktikrinimas());
		while(A[i].pazymiai[0]!=0){
			A[i].pazymiusk++;
			cout<<A[i].pazymiusk+1<<"-asis namu darbas"<<endl;
			A[i].pazymiai.insert(A[i].pazymiai.end(),Paztikrinimas());
				}
				A[i].pazymiusk--;
				cout<<"Iveskite egzamino rezultata"<<endl;
				A[i].egzaminas=Sktikrinimas();	
